...
// 2. wiązanie niejawne - co jest źródłem kontekstu, co jest źródłem wywołania
...
const showUser = function (name, age) {
    console.log(`Użytkownik ${name} ma pesel ${this.pesel}, ma ${age} lat`);
}
...
// Arrow nie tworzy wiązania this, a je dziedziczy
